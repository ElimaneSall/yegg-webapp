...
import { sampleWithRequiredData } from '../bus.test-samples';
...
describe('Bus Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.buses()[0]).toEqual(expect.objectContaining({ id: 26950 }));
  });

  describe('trackId', () => {
    it('should forward to busService', () => {
      const entity = { id: 26950 };
      jest.spyOn(service, 'getBusIdentifier');
      const id = comp.trackId(entity);
      expect(service.getBusIdentifier).toHaveBeenCalledWith(entity);
