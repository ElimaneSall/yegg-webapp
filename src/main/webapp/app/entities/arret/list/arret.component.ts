...
import { ArretService, EntityArrayResponseType } from '../service/arret.service';
...
export class ArretComponent implements OnInit {
  ...
  protected readonly arretService = inject(ArretService);
  ...
  trackId = (item: IArret): number => this.arretService.getArretIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.arrets.set(dataFromBody);
  }

  protected fillComponentAttributesFromResponseBody(data: IArret[] | null): IArret[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.arretService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
